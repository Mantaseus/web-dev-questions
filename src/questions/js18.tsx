...
export const Question: React.FC = () => <QuestionWrapper {...questionWrapperProps}>
  ...
  <p>
    Once you have filtered the array, extract the value of the <code>id</code> key from each of the objects in the
